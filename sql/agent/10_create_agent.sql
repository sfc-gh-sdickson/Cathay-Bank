...
CREATE OR REPLACE AGENT CATHAY_BANK_AGENT
  ...
  instructions:
    ...
    sample_questions:
      ...
      - question: "What is the FIBO definition of 'Know Your Customer' and what regulatory frameworks require it?"
        answer: "I'll resolve the KYC concept through the FIBO ontology to provide its formal definition, regulatory context, and related frameworks."
      - question: "How does the ontology connect KYC to AML to BSA? Navigate the relationships."
        answer: "I'll navigate the FIBO ontology relationships for KYC, AML, and BSA to show how these concepts are interconnected."
      - question: "What are the regulatory requirements under the Bank Secrecy Act? What compliance metrics should we track?"
        answer: "I'll retrieve BSA regulatory requirements from the FIBO ontology including compliance metrics, reporting frequency, and data elements."
      - question: "Resolve the concept 'credit risk' - what data elements does it map to and what are the Basel III requirements?"
        answer: "I'll resolve 'credit risk' through the FIBO ontology and retrieve Basel III requirements to show mapped data elements and regulatory standards."
      - question: "What FIBO relationships exist for 'Anti-Money Laundering'? What concepts does it connect to?"
        answer: "I'll navigate the FIBO ontology relationships for Anti-Money Laundering to show all connected concepts and relationship types."
      - question: "What are our BSA/AML compliance obligations for correspondent banking relationships?"
        answer: "I'll search our regulatory documents and compliance policies to explain BSA/AML obligations specific to correspondent banking."
      - question: "How many SARs have been filed year-to-date and what are the most common event types?"
        answer: "I'll query our compliance data for SAR filing counts and analyze the distribution of event types year-to-date."
      - question: "What are the current open compliance events at Critical or High severity and who are they assigned to?"
        answer: "I'll search our compliance events for open cases at Critical or High severity and provide assignment details."
      - question: "Explain our CRA performance plan and how we measure community reinvestment."
        answer: "I'll search our regulatory documents for the CRA performance plan and explain the community reinvestment measurement framework."
      - question: "What are the Basel III capital requirements that apply to Cathay Bank?"
        answer: "I'll search our regulatory framework documentation and FIBO ontology to explain applicable Basel III capital requirements."
      - question: "What does our BSA/AML compliance program manual say about transaction monitoring thresholds?"
        answer: "I'll search our BSA/AML compliance program documentation for transaction monitoring threshold policies and procedures."
      - question: "Give me the complete risk profile for customer 42 including deposits, loans, compliance events, and risk assessments."
        answer: "I'll retrieve the comprehensive risk profile for customer 42 covering all deposit balances, loan status, compliance history, and risk assessment scores."
      - question: "What is the overall portfolio summary including total deposits, loans, delinquency rate, and compliance status?"
        answer: "I'll pull the portfolio summary with total deposits, loan balances, delinquency rates, and current compliance status metrics."
      - question: "How many risk assessments are rated 'High' or 'Critical' and what are the most common risk categories?"
        answer: "I'll query our risk assessment data to count High and Critical ratings and analyze the distribution across risk categories."
      - question: "What is the compliance summary showing all open events, SARs filed, and KYC status across the customer base?"
        answer: "I'll retrieve the compliance summary including open events by severity, SAR and CTR filing counts, and KYC status distribution."
